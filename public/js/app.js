...
var app = angular.module('CarHexa_App', [
'ngRoute',
'ngResource'
...
// START - ROUTE
	...
	.when('/passengers/:id', {
	  templateUrl: 'html/PassengerEdit.html',
	  resolve: {
		  user: ["AuthenticationService", function(AuthenticationService) { return AuthenticationService.isAuthenticated(); }]
	  },
	})
	.when('/passengers', {
	  templateUrl: 'html/PassengerList.html',
	  resolve: {
		  user: ["AuthenticationService", function(AuthenticationService) { return AuthenticationService.isAuthenticated(); }]
	  },
	})
