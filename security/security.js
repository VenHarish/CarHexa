...
app.all(properties.api + '/*', function (req, res, next) {
    ...
    res.header("Access-Control-Allow-Headers", "X-Requested-With,Content-Type,user,pass,token,Authorization");
 ...
 * Login API
 */
app.post(properties.api + '/login', function (req, res) {
...
var createUser = function () {
    ...
    db_CarHexa_db = require('../db/CarHexa_db_schema.js');
    db_CarHexa_db.User.count().exec(function (err, count) {
        if (count == 0) {
            var admin = new db_CarHexa_db.User({
                username: 'admin',
